...
class Interceptor extends \Magento\Webapi\Controller\Soap\Request\Handler implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\Webapi\Request $request, \Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Webapi\Model\Soap\Config $apiConfig, \Magento\Framework\Webapi\Authorization $authorization, \Magento\Framework\Api\SimpleDataObjectConverter $dataObjectConverter, \Magento\Framework\Webapi\ServiceInputProcessor $serviceInputProcessor, \Magento\Framework\Reflection\DataObjectProcessor $dataObjectProcessor, \Magento\Framework\Reflection\MethodsMap $methodsMapProcessor, ?\Magento\Webapi\Controller\Rest\ParamsOverrider $paramsOverrider = null)
    {
        $this->___init();
        parent::__construct($request, $objectManager, $apiConfig, $authorization, $dataObjectConverter, $serviceInputProcessor, $dataObjectProcessor, $methodsMapProcessor, $paramsOverrider);
    }

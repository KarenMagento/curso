...
class Interceptor extends \Magento\ReCaptchaValidation\Model\Validator implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\Validation\ValidationResultFactory $validationResultFactory, \Magento\ReCaptchaValidationApi\Model\ErrorMessagesProvider $errorMessagesProvider, \ReCaptcha\ReCaptchaFactory $reCaptchaFactory)
    {
        $this->___init();
